...
A11B11C11=ProductOps(A11B11,C11);
A21B21C11=ProductOps(A21B21,C11);
A21B11C21=ProductOps(A21B11,C21);
A11B21C21=ProductOps(A11B21,C21);
...
a11b11c11=v(IndexOf(A11B11C11,G));
a21b21c11=v(IndexOf(A21B21C11,G));
a21b11c21=v(IndexOf(A21B11C21,G));
a11b21c21=v(IndexOf(A11B21C21,G));
...
optimize(F,obj);
B(1)=double(-obj);%Mermin Optimised

%silva 1:-7 + 8 A11 + 8 B11 - 8 A11 B11 + 8 C11 - 8 A11 C11 - 8 B11 C11 + 
% 8 A11 B11 C11
obj= -7+8*(a11+b11+c11)-8*(a11b11+a11c11+b11c11)+8*a11b11c11;
optimize(F,-obj);
B(2)=double(obj); %Silwa 1 Optimized.

%silwa2 = -2 + 4 A21 + 4 B11 - 4 A11 B11 - 4 A21 B11 + 4 A11 B21 - 4 A21 B21 + 
 %4 C11 - 4 A11 C11 - 4 A21 C11 - 4 B11 C11 + 8 A11 B11 C11 - 
 %4 B21 C11 + 8 A21 B21 C11 + 4 A11 C21 - 4 A21 C21 - 4 B11 C21 + 
 %8 A21 B11 C21 + 4 B21 C21 - 8 A11 B21 C21
obj= -2+4*a21+4*b11-4*a11b11-4*a21b11+4*a11b21-4*a21b21+4*c11-4*a11c11-4*a21c11-4*b11c11+8*a11b11c11-4*b21c11+8*a21b21c11+4*a11c21-4*a21c21-4*b11c21+8*a21b11c21+4*b21c21-8*a11b21c21;

optimize(F,-obj);
B(3)=double(obj); %silwa 2 Optimized.

%silwa 3.

obj=-2 + 4*a11 + 4*b11 - 4*a11b11 - 4*a21b11 - 4*a11b21 + 4*a21b21 + 4*c11 - 4*a11c11 - 4*a21c11 - 8*b11c11 + 8*a11b11c11 + 8*a21b11c11 - 4*a11c21 + 4*a21c21 + 8*a11b21c21 - 8*a21b21c21;
optimize(F,-obj);
B(4)=double(obj); %silwa 3 optimized.

%silwa 4

obj=2 - 8*b11 + 8*a11b11 - 8*c11 + 8*a11c11 + 8*b11c11 -8*a11b11c11 + 8*b21c11 - 8*a11b21c11 + 8*b11c21 -8*a11b11c21 - 8*b21c21 + 8*a11b21c21;
optimize(F,-obj);
B(5)=double(obj);

%silwa 7

obj=-4 + 8*a11 + 8*b11 - 16*a11b11 + 8*c11 - 16*a11c11 - 16*b11c11 +24*a11b11c11 + 8*a21b11c11 + 8*a11b21c11 - 8*a21b21c11 +  8*a11b11c21 - 8*a21b11c21 - 8*a11b21c21 + 8*a21b21c21;
optimize(F,-obj);
B(6)=double(obj)
